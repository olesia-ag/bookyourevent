...
const Confirmation = props => {
  ...
  const renderConfirmation=()=>{
    ...
    if(!props.history.location.state||!props.history.location.state.date||
      (props.history.location.state.date&&props.history.location.state.date===new Date())||(props.history.location.state.submitted === false)){
      return (
